...
export class SignupComponent {
  ...
  formSubmit(username: String, fullName: String, email: String, course: String, password: String) {

    const raw: any = JSON.stringify({ username, fullName, email,course, password });
